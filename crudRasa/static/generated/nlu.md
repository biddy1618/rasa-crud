## intent:Online credit
  - online credit
  - как запускать заявка online credit
  - как запускать заявка онлайн кредит
  - онлайн кредит

## intent:default
  - почему списывать комиссия пополнение баланс
  - в шок
  - форте банк ты гнать
  - аулааор
  - урп сегодня работать
  - курс доллар
  - föfjötjl
  - соединять с оператор
  - прввирпаролы
  - талкин квест
  - кто президент казахстан
  - эээ
  - хотеть оставлять жалоба
  - это решать
  - сегодня отделение работать
...
## intent:dialogs - bot - become clever
  ...
  - ты пень пень
  - ты голова еловый
  - ты малый не дурак дурак не малый
...
## intent:dialogs - bot - hobby
  ...
  - твой интерес
  - ты хобби
  - как ты проводить свой время
  - ты делать когда не занимать
  - как ты проводить свободный время
  - твой любимый дело
...
## intent:dialogs - bot - how to meet
  - как познакомиться с мужчина
  - как познакомиться с парень
  - как находить девушка
  - почему нет второй половина
  - почему не женатый
  - как познакомиться с девушка
  - почему нет парень
  - почему не замужем
  - почему не встречать свой любовь
  - почему нет девушка
  - почему неженатый
  - почему нет жена
  - находить парень
  ...
  - почему незамужем
  - почему не брать замуж
  - почему нет ребенок
  - почему холостой
  - почему в развод
  - почему разводить
  - почему на никто не смотреть
  - почему холостой
  - как познакомиться с женщина
  - почему нет ребенок
  - почему нет муж
...
## intent:dialogs - bot - i dont want to talk
  - не хотеть с ты говорить
  - не хотеть вести с ты беседа
  - не хотеться общение
  - нет желание с ты общаться
  - не хотеть с ты разговаривать
...
## intent:dialogs - bot - i dont want to work
  ...
  - бесить работа
  - нет жила работать
  - не хотеть сидеть на работа
  - завтра на работа не хотеть
  - бесить работа
  - не охота работать
...
## intent:dialogs-bot-what_can_you_do
  ...
  - твой функция
  - ты нужный
  - как помогать новый пользователь
  - нужный помощь
  - ты обучать
  - помощь
  - помогать
  - ты мочь делать
  - как помогать пользователь
...
## intent:guide-forte-cards-cardissueandactivation-activation
  - активировать карта
  - активация карта
  - как активировать новый карта
  - активировать карта
  - хотеть активировать карта
  - не мочь активировать карта
  - активация карта
...
## intent:guide-forte-cards-cardissueandactivation-activation-epinatm
  ...
  - как устанавливать e pin в банкомат
  - как устанавливать е пин в банкомат
...
## intent:guide-forte-cards-conditions-jastar
  - jastar карта ребенок подросток
...
## intent:guide-forte-cards-conditions-promotions-taxi
  ...
  - такси
  - такси с cashback
  - хотеть в cashback в такси
  - прокатиться с forte

## intent:guide-forte-cards-conditions-selfiecard
  - selfiecard с индивидуальный дизайн
...
## intent:guide-forte-cards-questions-epin
  - не поступать смс установление е пин

## intent:guide-forte-cards-questions-mib
  - не получаться подключать мобильный банкинг

## intent:guide-forte-cards-reference
  - справка наличие счет
  - получать справка наличие счет
  - хотеть справка наличие счет
  - паспорт счет
...
## intent:guide-forte-cards-usecard-cashwithdrawal-abroad-jastar
  ...
  - карта ребенок
  - нужный карта не совершеннолетний
...
## intent:guide-forte-cards-usecard-dop
  ...
  - как открывать дополнительный карта
...
## intent:guide-forte-cards-usecard-nopin
  - забывать пин код
  - изменение пин код
  - как изменитьпина код
  - смена pin
  - изменение пин код карта
  - как изменитьпина код карта
  - смена pin карта
  - забывать пин код
  - забывать pin карта
  - хотеть сменить пин
...
## intent:guide-forte-creditcard-reference
  - справка отсутствие ссудный задолженность
  - получать справка отсутствие ссудный задолженность
  - хотеть справка отсутствие ссудный задолженность
...
## intent:guide-forte-creditcard-stock-travel
  ...
  - как путешестовывать в рассрочка
  - тур в рассрочка
  - путешествие в рассрочка
  - хотеть путешествовать без переплата

## intent:guide-forte-creditcard-stock-vseremont
  - все ремонт без
  - сделать ремонт без
  - ремонт без переплата
  - хотеть сделать ремонт без
  - хотеть ремонт без переплата
...
## intent:guide-forte-deposits-advantages-withoutpartialwithdrawal
  - срочный депозит без частичный изъятие
...
## intent:guide-forte-loan-mortgage-emergencyloan
  ...
  - как оформлять кредит на неотложный нужда
...
## intent:help-forte-card-cash-without-card
  - снимать деньги без карта
  - забывать карта нужно обналичивать
  - получать деньги без карта
  - деньги без карта
  - как воспользоваться услуга получать деньги без карта
  - как воспользоваться услуга cash by code
  - забывать карта хотеть обналичивать
...
## intent:guide-forte-loan-unsecured-expressloan-stock-samsung
  - скидка 30 на смартфон  « samsung »

  - скидка 17 ]( time )%  на смартфон самсунг
  - скидка самсунг
  - скидка samsung
  - samsung
  - самсунг
  - скидка 17 ]( time )%  на смартфон  « samsung »
...
## intent:guide-forte-mib-finescontrol
  ...
  - как настройт уведомление наличие штраф
  - как получать смс начисление административный штраф
  - как получать смс начисление штраф пдд
...
## intent:guide-forte-mib-security-cardlock
  ...
  - потерять карта как заблокировать
  - украсть карта как заблокировать
...
## intent:help-forte-credentials-password
  - сменить пароль
  - забывать пароль
  - как сменить пароль вход в приложение
  - как сменить пароль вход в мобильный банкинг
  - как сменить пароль вход в интернет банкинг
  - не помнить пароль
...
## intent:guide-forte-mib-transferandpay-transfercontact
  ...
  - как сделать перевод на номер телефон
...
## intent:help-forte-card-unblock
  - карта заблокировать как возможно разблокировать
  - разлокировать карта
  - разблокировка карта
...
## intent:help-forte-cards-usecard-epinandactivation-epin7575
  ...
  - как устанавливать e pin контакный центр
  - как устанавливать е пин контакный центр
...
## intent:help-forte-cards-usecard-limits-increase
  - как мочь увеличивать лимит на операция
  - изменение лимит операция
  - как увеличивать изменять лимит самостоятельно
...
## intent:help-forte-credit-card-conditions
  - здравствовать как получать условие кредитный карта
...
## intent:help-forte-credit-card-installmentplan
  - как работать кредитный карта
  - как работать рассрочка кредитный карта
...
## intent:help-forte-debit-card-issuance
  ...
  - как выпускать карта не посещать отделение
...
## intent:help-forte-leadership
  ...
  - совет директор банк
  - кто управлять банк
  - кто управлять fortebank
  - правление fortebank
  - руководство форте банк
  - руководитель fortebank
  - руководство форте
  - руководитель
  - руководство банк

## intent:help-forte-leadership-abdrazakov
  - кто абдразаков ельдар
  - кто ельдар абдразаков
  - ельдар абдразаков
  - абдразак ельдар
...
## intent:help-forte-leadership-andronikashvili
  ...
  - кто гурам андроникашвили
  - кто андроникашвили гурам
...
## intent:help-forte-leadership-batyrbekov
  - адиль батырбеков
  - батырбеков адиль
  - кто адиль батырбеков
  - кто батырбеков адиль
...
## intent:help-forte-leadership-bisembieva
  - гаухар бисембиев
  - бисембиев гаухар
  - кто гаухар бисембиев
  - кто бисембиев гаухар
...
## intent:help-forte-leadership-utemuratov
  - ануар утемуратов
  - утемуратов ануар
  - кто ануар утемуратов
  - кто утемуратов ануар

## intent:help-forte-limits-abroad
  - выезжать в отпуск заграницу как пользоваться карточка
  - выезжать на учеба рубеж как пользоваться карточка
  - как обезопасить карта граница

## intent:help-forte-limits-deposit
  - не мочь переводить деньги с депозит на свой карта
  - не мочь переводить деньги с депозит на свой счет

## intent:help-forte-limits-how
  - мочь устанавливать лимит карта
  - как мочь устанавливать лимит карта
  - нужно увеличивать лимит карта
  - нужно увеличивать лимит на переовдный операция

## intent:help-forte-limits-tocard
  - не мочь переводить деньги на карта в другой банк
...
## intent:help-forte-loan-application
  - как мочь подавать заявка на кредит
  - как мочь подавать заявка экспресс кредит
  - как получать кредит
  - как получать экспресс кредит
  - нужный кредит
...
## intent:help-forte-mib-advantage-0balance
  - как расходоваться трафик приложение
  - без роуминг делать операция в приложение
  - без роуминг делать операция в мобильный приложение
  - без роуминг делать операция в мобильный банкинг
  - мобильный приложение 0 баланс
  - заканчиваться трафик
  - нет интернет как совершать операция счет
  - нет интернет как сделать платеж
  - нет интернет как сделать перевод
...
## intent:help-forte-open-account
  ...
  - как открывать текущий счет не посещать отделение

## intent:help-forte-open-deposit
  - как открывать депозит
  ...
  - как открывать депозит не посещать отделение
...
## intent:help-forte-quest
  - задание fortequest
  - хотеть узнавать задание форте квеста
  - задание форте квест
  - написать задание fortequest
  - хотеть узнавать задание fortequest

## intent:help-forte-registration
  - не получаться зарегистрироваться
  - не получаться активироваться
  - не мочь зарегистрироваться
  - не мочь активироваться
  - не мочь проходить регистрация

## intent:help-forte-statement
  - как получать выписка карточный счет
  - как получать выписка текущий счет
  - как получать выписка депозитный счет
  - получать выписка счет
  - удаленный получать выписка карта
  - возможно получать выписка счет не отбращаться в отделение
  - возможно получать выписка карта не отбращаться в отделение

## intent:help-forte-transaction-statement
  - как сформировывать чек подтверждать совершение платеж проведение операция
  - как сформировывать чек подтверждать совершение перевод проведение операция
  - как сформировывать квитанция подтверждать совершение платеж проведение операция
  - как сформировывать квитанция подтверждать совершение перевод проведение операция
  - посмотреть чек операция
  - посмотреть квитация операция
  - как посмотреть чек совершенный перевод
  - как посмотреть чек совершенный платеж
  - как посмотреть квитанция совершенный платеж
  - как посмотреть квитанция совершенный перевод

## intent:help-forte-transfers
  - не проходить перевод
  - не мочь переводить деньги

## intent:help-forte-transfers-2-legal-entities
  - как сделать перевод на счет юр лицо
  - не мочь сделать перевод на счет юр лицо
  - как совершать перевод на счет юр лицо

## intent:help-forte-transfers-2-other-bank-card
  - сделать перевод на карта другой банк
  - как переводить деньги на карта другой банк

## intent:help-forte-transfers-atm
  - как сделать перевод в банкомат
  - как совершать перевод в атма
  - перевод в банкомат
  - перевод банкомат
  - как совершать перевод в банкомат
...
## intent:help-forte-transfers-dep2other
  - не проходить перевод с депозит в польза третий лицо
  - не мочь сделать перевод с депозит на карта другой банк
  - не мочь переводить деньги с депозит на счет другой клиент ао fortebank
  - не мочь переводить деньги с депозит на счет другой клиент fortebank
  - не мочь переводить деньги с депозит на счет другой клиент форте банк

## intent:help-forte-transfers-exchange-rate
  - курс конвертация перевод
  - как узнавать курс конвертация
  - посмотреть курс конвертация
...
## intent:help-forte-transfers-socianetw-odnokl
  ...
  - как сделать перевод в одноклассник
